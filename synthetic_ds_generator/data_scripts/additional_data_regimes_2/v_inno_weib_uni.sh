...
specs=(
 "inno_weib_2_3 n_vars=2 generator.lagged.max_lags=3 generator.inno_n.which_non_gaussian=weibull"
 "inno_uni_2_3 n_vars=2 generator.lagged.max_lags=3 generator.inno_n.which_non_gaussian=uniform"
)
