...
specs=(
 "inno_shock_7_2 n_vars=7 generator.lagged.max_lags=2 generator.inno_n.shock=True"
 "inno_shock_3_2 n_vars=3 generator.lagged.max_lags=2 generator.inno_n.shock=True"
 "inno_shock_3_4 n_vars=3 generator.lagged.max_lags=4 generator.inno_n.shock=True"
)
