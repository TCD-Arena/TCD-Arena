...
cmd3=" generator.inno_n.non_additive_noise_proba=0.8,0.85,0.9,0.95,1"
...
specs=(
 "inno_time_7_2 n_vars=7 generator.lagged.max_lags=2 generator.inno_n.time_dependent=True"
 "inno_time_3_2 n_vars=3 generator.lagged.max_lags=2 generator.inno_n.time_dependent=True"
 "inno_time_3_4 n_vars=3 generator.lagged.max_lags=4 generator.inno_n.time_dependent=True"
)
