...
specs=(
    "$cmd name=no_violation_7_2$cmd2 n_vars=7 generator.lagged.max_lags=2$output_dir_param"
    "$cmd name=no_violation_3_2$cmd2 n_vars=3 generator.lagged.max_lags=2$output_dir_param"
    "$cmd name=no_violation_3_4$cmd2 n_vars=3 generator.lagged.max_lags=4$output_dir_param"
)
