...
cmd3=" generator.interpolate=0.2,0.3375,0.475,0.6125,0.75 generator.missingness_type=MCAR"
...
specs=(
 "mcar_7_2 n_vars=7 generator.lagged.max_lags=2"
 "mcar_3_2 n_vars=3 generator.lagged.max_lags=2"
 "mcar_3_4 n_vars=3 generator.lagged.max_lags=4"
)
