...
cmd2=" generator.time_series_n=1000 seed=$seed n_samples=100 generator.lagged.link_proba=0.075,0.15 generator.exog.param_range='[0.8,0.9]'"
cmd3=" generator.exog.link_proba=0.135,0.27625,0.4175,0.55875,0.7 generator.instant.link_proba=0.1"
...
specs=(
 "conf_i_7_2 n_vars=7 generator.lagged.max_lags=4"
 "conf_i_3_2 n_vars=3 generator.lagged.max_lags=2"
 "conf_i_3_4 n_vars=3 generator.lagged.max_lags=4"
)
