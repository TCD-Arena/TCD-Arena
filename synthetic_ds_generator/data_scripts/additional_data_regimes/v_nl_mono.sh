...
cmd3=" nonlinear_proba=1 nl_mode=\"power_set\" power_dist=\"[0.5,1,1,2]\",\"[0.25,0.5,2,4]\",\"[0.125,0.25,4,8]\",\"[0.0833,0.125,8,12]\",\"[0.05,0.0833,12,20]\""
...
specs=(
 "nl_mono_7_2 n_vars=7 generator.lagged.max_lags=2"
 "nl_mono_3_2 n_vars=3 generator.lagged.max_lags=2"
 "nl_mono_3_4 n_vars=3 generator.lagged.max_lags=4"
)
