...
cmd3=" generator.inno_n.non_additive_noise_proba=0.35,0.5,0.65,0.8,0.95"
...
specs=(
 "inno_auto_7_2 n_vars=7 generator.lagged.max_lags=2 generator.inno_n.autoregressive=True"
 "inno_auto_3_2 n_vars=3 generator.lagged.max_lags=2 generator.inno_n.autoregressive=True"
 "inno_auto_3_4 n_vars=3 generator.lagged.max_lags=4 generator.inno_n.autoregressive=True"
)
