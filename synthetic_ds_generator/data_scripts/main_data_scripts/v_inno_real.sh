...
NOISE_PROB_ARGS=" generator.inno_n.non_additive_noise_proba=0.8,0.85,0.9,0.95,1"
...
specs=(
    ...
    "inno_real_big generator.inno_n.semi_synthetic=True"
    "inno_real_small generator.inno_n.semi_synthetic=True"
)
