...
for x in 0.135,0.27625,0.4175,0.55875,0.7; do
    specs+=("conf_l_small n_vars=6 generator.lagged.alternative_link_proba=${x} generator.lagged.alternative_coeff_ts=1 generator.lagged.max_lags=3 ")
done

for x in 0.135,0.27625,0.4175,0.55875,0.7; do
    specs+=("conf_l_big n_vars=8 generator.lagged.alternative_link_proba=${x} generator.lagged.alternative_coeff_ts=1 generator.lagged.max_lags=4 ")
done
