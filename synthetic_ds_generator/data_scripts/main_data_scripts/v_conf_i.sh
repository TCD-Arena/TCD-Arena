...
cmd2=" generator.time_series_n=250,1000 seed=$seed n_samples=100 generator.lagged.link_proba=0.075,0.15 generator.exog.param_range='[0.8,0.9]'"
...
specs=(
 "conf_i_big n_vars=7 generator.lagged.max_lags=4"
 "conf_i_small n_vars=5 generator.lagged.max_lags=3"
)
