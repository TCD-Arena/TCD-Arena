...
NOISE_PROB_ARGS=" generator.inno_n.non_additive_noise_proba=0.35,0.5,0.65,0.8,0.95"
...
specs=(
    ...
    "inno_auto_big generator.inno_n.autoregressive=True"
    "inno_auto_small generator.inno_n.autoregressive=True"
)
