...
NOISE_PROB_ARGS=" generator.inno_n.non_additive_noise_proba=0.91,0.93,0.95,0.97,0.99"
...
specs=(
    ...
    "inno_multiplicative_big generator.inno_n.multiplicative=True"
    "inno_multiplicative_small generator.inno_n.multiplicative=True"
)
